    ...
    def __log_ltr_query_features(self, query_id, key, query_doc_ids, click_prior_query, no_results, terms_field="_id"):
        ...
        if response and len(response['hits']) > 0:
            ...
            for hit in hits:
                ...
                log_features = hit['fields']['_ltrlog'][0]['log_entry']
                for log_feature in log_features:
                    feature_name = log_feature['name']
                    feature_value = 0 if "value" not in log_feature else log_feature['value']
            ...
            print("No results for log_query")
